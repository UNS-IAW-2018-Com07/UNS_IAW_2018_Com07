...
function mostrarListado() {
    ...
    document.getElementById("barraMenu").setAttribute('class','col-md-2 barraMenu barraMenuListado'); 
...
function ocultarListado() {
    ...
    document.getElementById("barraMenu").setAttribute('class','col-md-2 barraMenu barraMenuMapa'); 
}
